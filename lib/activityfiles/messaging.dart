...
class MessagingScreen extends StatefulWidget {
  ...
  final String chatId;
  final String title;
  MessagingScreen({this.prefs, this.chatId,this.title});
  @override
  MessagingScreenState createState() {
    return new MessagingScreenState();
  }
}
          ...
          children: <Widget>[
            ...
            new Container(                          
              ...
              child: documentSnapshot.data['image_url'] != ''
                  ...
                  : new Text(documentSnapshot.data['text'], style: TextStyle(color: Colors.white),),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.title, style: TextStyle(fontFamily: 'SF Pro', color: Color(0xFF00284B), fontSize: 20.0, fontWeight: FontWeight.bold),),
        iconTheme: IconThemeData(
          color: Color(0xFF00284B), //change your color here
        ),
      ),
      body: Container(
        padding: EdgeInsets.all(5),
